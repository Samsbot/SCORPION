...
*Made by Scorpion King*\n\n`
      ...
      fileStream.on('finish', () => {
        ...
        zk.sendMessage(origineMessage, { video: { url :"./video.mp4"} , caption: "༆IN ORDER OF SCORPION KING༄", gifPlayback: false }, { quoted: ms });
      });
